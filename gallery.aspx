   ...
   <div id="header">
       ...
       <div id="logo"> <img src="images/logo.jpg" width="400" height="100"></div>
		  <div id="nav"><ul>
                ...
                <li class="current"><a href="gallery.aspx" target="_parent">GALLERY</a></li>
	...
	<div class="content">
		<div>
			<div><img src="images/gallery_banner.jpg" width="960" height="380"></div>
			<div>
				<div id="sidebar">
...
<br />
			  ...
			  <div id="aside">
				<h1>Gallery:</h1>
                  ...
                  <!--Image for marthon Race Date-06/02/2017-->
                  
                   <asp:Repeater ID="rptr_galeryImgg" runat="server"  >
                 <ItemTemplate>


                   <li><a class="vlightbox1" href="manod_admin/AdminImg/<%#Eval("galeryImgg")%>" rel="prettyPhoto[gallery1]" title="<%#Eval("galeryDescp")%>"><img src="manod_admin/AdminImg/<%#Eval("galeryImgg")%>" alt="MANAGE AUTISM NOW" width="140" height="96" class="gallery_image" /></a></li>
                     </ItemTemplate>
                 </asp:Repeater>
		  ...
		  <div id="Div1" >   <div id="next_page" runat="server">
                    ...
                    <%--  <div id="preview">  <div id="next_page">
                        <a class="gal_num" href="gallery.html">1</a>
                        <a class="gal_num" href="gallery_second_page.html">2</a>
                        <a class="gal_num" href="gallery_thrid_page.html">3</a>
                    </div></div>--%>
