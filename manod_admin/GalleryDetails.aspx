<%@ Page Title="" Language="C#" MasterPageFile="~/manod_admin/manodishaMasterPage.master" AutoEventWireup="true" CodeFile="GalleryDetails.aspx.cs" Inherits="manod_admin_GalleryDetails" %>
...
<div class="breadcrumbs ace-save-state" id="Div1">
						<ul class="breadcrumb">
                            ...
                            <li>
								<a href="galleryList.aspx">Gallery List</a>
							</li>
                    ...
                    <div class="page-header"><h1>Welcome to Gallery Details </h1></div>
                      <div class="row">
							<div class="col-xs-12">
                                     
                                       <div class="form-group">
										<div class="col-sm-12"><span style="font-size:20px;">Gallery Description</span><br /><br />
											<div class="pos-rel">
                                                <cc1:Editor ID="edtr_descp" runat="server" />
