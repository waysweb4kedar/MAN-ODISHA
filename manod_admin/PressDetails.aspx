<%@ Page Title="" Language="C#" MasterPageFile="~/manod_admin/manodishaMasterPage.master" AutoEventWireup="true" CodeFile="PressDetails.aspx.cs" Inherits="manod_admin_PressDetails" %>
...
<div class="breadcrumbs ace-save-state" id="Div1">
						<ul class="breadcrumb">
                            ...
                            <li>
								<a href="PressList.aspx">Press List</a>
							</li>
							<li class="active"> <a href="#">Press Details</a></li>
						</ul><!-- /.breadcrumb -->
					</div>
                     <!-- /.page-content -->
                       <div class="page-content">

                    <div class="page-header"><h1>Welcome to Press Details </h1></div>
                      <div class="row">
							<div class="col-xs-12">
                                     
                                       <div class="form-group">
										<div class="col-sm-12"><span style="font-size:20px;">Press Description</span><br /><br />
											<div class="pos-rel">
                                                <cc1:Editor ID="edtr_Desc" runat="server" />
