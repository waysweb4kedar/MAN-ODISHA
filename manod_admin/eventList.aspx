<%@ Page Title="" Language="C#" MasterPageFile="~/manod_admin/manodishaMasterPage.master" AutoEventWireup="true" CodeFile="eventList.aspx.cs" Inherits="manod_admin_eventList" %>
...
<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active"> <a href="#">Event List</a></li>
						</ul><!-- /.breadcrumb -->
					</div>
...
<div class="row">
                                    ...
                                    <asp:LinkButton ID="lnb_newEvent" runat="server" CssClass="btn btn-primary" onclick="lnb_newEvent_Click" 
                                           >
								...
								<div style="overflow:scroll;height:875px;">
                                        ...
                                        <asp:GridView ID="grd_event" runat="server" CssClass="table  table-bordered table-hover"
                                       AutoGenerateColumns="False"  PageSize="15" AllowPaging="True" 
                                            onpageindexchanging="grd_event_PageIndexChanging" 
                                            onrowdatabound="grd_event_RowDataBound" onrowdeleting="grd_event_RowDeleting" onrowupdating="grd_event_RowUpdating" 
                                              >
                                        <Columns>
